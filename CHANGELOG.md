...
### Changed
- **Top 3 priorities: commute, schools, price** — AI scorer now explicitly prioritizes: (1) commute ≤90min (over 90 = hard reject), (2) schools 80th+ percentile, (3) price $1.5M target / $1.8M hard cap (was $2M). These are the highest-weight factors. PRD updated with new scoring table and hard requirements.
