...
class Settings(BaseSettings):
    ...
    # Alert senders
    alert_senders: str = "ken.wile@redfin.com,KEY@northeastmatrixmail.com,noreply@redfin.com"
    ...
    # Auth
    allowed_emails: str = "akibalogh@gmail.com,bronwyneharris@gmail.com,aki@bitsafe.finance"
    session_secret: str = ""
